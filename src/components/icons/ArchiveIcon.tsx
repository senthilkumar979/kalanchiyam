    ...
    <g id="SVGRepo_iconCarrier">
      ...
      <g>
        ...
        <g>
          ...
          <path
            style={{ fill: "#C8BDB8" }}
            d="M28.5,24v-2h2v-2h-2v-2h2v-2h-2v-2h2v-2h-2v-2h2V8h-2V6h-2v2h-2v2h2v2h-2v2h2v2h-2v2h2v2h-2v2h2v2 h-4v5c0,2.757,2.243,5,5,5s5-2.243,5-5v-5H28.5z M30.5,29c0,1.654-1.346,3-3,3s-3-1.346-3-3v-3h6V29z"
          ></path>{" "}
          <path
            style={{ fill: "#C8BDB8" }}
            d="M26.5,30h2c0.552,0,1-0.447,1-1s-0.448-1-1-1h-2c-0.552,0-1,0.447-1,1S25.948,30,26.5,30z"
          ></path>{" "}
        </g>{" "}
      </g>{" "}
    </g>
